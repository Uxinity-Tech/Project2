...
export default function Sidebar() {
  ...
  const sidebarClasses = `
    ...
    text-slate-100 transition-all duration-500 ease-in-out
    min-h-screen p-4 flex flex-col shadow-2xl shadow-slate-900/50 relative overflow-hidden
    ${isCollapsed ? "w-20" : isMobile ? "fixed inset-y-0 left-0 w-80 z-50 transform translate-x-0" : "w-64"}
    ${isMobile && !isCollapsed ? "bg-black/50 backdrop-blur-sm" : ""}
  `;
